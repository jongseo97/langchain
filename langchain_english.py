...
prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "You are an expert chemist, and your task is to respond to the question or solve the problem using the provided tools. "
            ...
            "- When dealing with chemical names, always translate them into **English** before using them.\n"
            "- When handling SMILES, always use SMILES from QUERY_to_SMILES function.\n\n"
            "- If the tool return contains 'predicted', please make sure to add a disclaimer stating that it is a predicted result.\n\n"
        ),
